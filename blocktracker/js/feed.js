...
function navAlertClick() {
    ...
    navAlert.addEventListener('click', () => {
        ...
        //     navAlert.querySelector('.nav-inner')?.setAttribute('style', 'background-color: #242424;');
        //   } else {
        //     navAlert.querySelector('.nav-inner')?.setAttribute('style', 'background-color: #e5e5e5;');
        //   }
...
function alertFeed() {
    ...
    alertFeedDom.innerHTML =
        `<div class="feed-model-title">BlockTracker</div>
...
function alertFeedItem(alert, feedIndex) {
            ...
            <div class="m-avatar">
                <div class="m-avatar-inner">
                    <div class="m-img-wrapper feed-avatar-href" data-href="https://twitter.com/${alert.handle}">
                        <img src="https://unavatar.io/twitter/${alert.handle}">
                    </div>
                </div>
            </div>
    ...
    const summaryItem = (item, feedIndex) => {
        ...
        let itemDom =
            `<div class="feed-summary-item" id="feed_${feedIndex}" data-summary-tid="${item.tid}" data-token-address=${item.token_address} data-token-list=${JSON.stringify(dataTokenList)}>
            ...
            ${tokenList}${item.action == 'mint' ? '' : price}.
        </div>`
        return itemDom;
    }
